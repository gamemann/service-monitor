...
pub struct HttpCheckConfig {
    #[serde(default = "HttpCheckConfig::def_http_method")]
    pub method: String,

    #[serde(default = "HttpCheckConfig::def_http_url")]
    pub url: String,

    #[serde(default = "HttpCheckConfig::def_http_timeout")]
    pub timeout: u64,

    #[serde(default = "HttpCheckConfig::def_http_is_insecure")]
    pub is_insecure: bool,

    pub body: Option<String>,

    #[serde(default = "HttpCheckConfig::def_body_is_file")]
    pub body_is_file: bool,

    pub headers: Option<HashMap<String, String>>,

    #[serde(default = "HttpCheckConfig::def_http_accept_codes")]
...
#[derive(Deserialize, Clone)]
pub struct Check {
    #[serde(default = "Check::def_cron")]
    pub cron: String,

    #[serde(rename = "type", default = "Check::def_check_type")]
