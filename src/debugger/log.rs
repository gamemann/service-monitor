...
impl Logger {
    pub fn new(level: LogLevel, log_file: Option<String>, input_mode: bool) -> Self {
        Logger {
            level,
            log_file,
            input_mode,
    ...
    pub fn log(&self, level: LogLevel, message: &str, skip_input: bool) {
        ...
        // If in input mode, we need to clear the current line, print the message, and flush.
        if !skip_input && self.input_mode {
            print!("\r\x1b[K");
        }
